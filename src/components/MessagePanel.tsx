  ...
  const [messages] = useState<Message[]>([
    {
      ...
      conversation: [
        ...
        },
        {
          id: '1-2',
          sender: 'me',
          content: '好的！我刚才以收到您的消息并更新了项目状态。',
          time: '10:32',
        },
        {
          id: '1-3',
          sender: 'other',
          content: '太好了！另外，让我们确定年度大会来"网站重新设计"任务。',
          time: '10:35',
        },
        {
          id: '1-4',
          sender: 'me',
          content: '当然你事情。另外，我们需要一些制助您经验完成这些任务吗？',
          time: '10:38',
        },
        {
          id: '1-5',
          sender: 'other',
          content:
            '我数据尺寸不太重！让我们保持这个项目在正确的轨道上，如果您需要更多时间或支持，请告诉我。',
          time: '10:40',
        },
      ],
    },
      ...
      conversation: [
        {
          id: '3-1',
          sender: 'other',
          content: '你好，大家！另外，让我们确定年度大会来"网站重新设计"项目的时间表。',
          time: '08:45',
        },
      ],
    },
      ...
      conversation: [
        {
          id: '5-1',
          sender: 'other',
          content: '你好，大家！另外，让我们确定年度大会来"网站重新设计"的具体安排。',
          time: '昨天',
        },
      ],
    },
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      <h4 className="text-sm font-medium text-gray-900">{message.user}</h4>

      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg transition ${
              activeMenu === '系统设置' ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50'
            }`}
          >
            <span>⚙️</span>
          ...
          {activeTab === '系统' && (
            <div className="max-w-3xl space-y-8">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-600 mb-6">您的帐户状态仍然处于活动状态已使用帐户的约</p>

                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="text-sm font-semibold text-red-900 mb-1">停用账户</h4>
                      <p className="text-sm text-red-700">停用您的帐户将停止所有活动并删除所有数据。您可以随时重新激活它。</p>
                    </div>

...
export default function Calendar() {
  ...
  const events: CalendarEvent[] = [
    { id: '1', title: '设计评审会议', startTime: '08:00', endTime: '09:00', date: '2025-12-24', color: 'bg-emerald-100 border-l-4 border-emerald-400', description: '讨论项目目标，可交付成果和时间表' },
    { id: '2', title: '营销活动发布计划', startTime: '11:00', endTime: '12:00', date: '2025-12-24', color: 'bg-pink-100 border-l-4 border-pink-400', description: '制定营销策略和推广方案' },
    { id: '3', title: '方客户会同步配送', startTime: '09:00', endTime: '10:00', date: '2025-12-25', color: 'bg-amber-100 border-l-4 border-amber-400', description: '与客户同步项目进度' },
    { id: '4', title: '设计评审会议', startTime: '08:00', endTime: '09:00', date: '2025-12-26', color: 'bg-emerald-100 border-l-4 border-emerald-400', description: '评审最新设计方案' },
    { id: '5', title: '设计评审会议', startTime: '06:00', endTime: '09:00', date: '2025-12-26', color: 'bg-emerald-100 border-l-4 border-emerald-400', description: '早会讨论设计细节' },
    { id: '6', title: '设计评审会议', startTime: '08:00', endTime: '09:00', date: '2025-12-27', color: 'bg-emerald-100 border-l-4 border-emerald-400', description: '设计方案最终确认' },
    { id: '7', title: '方客户会同步配送', startTime: '09:00', endTime: '10:00', date: '2025-12-27', color: 'bg-amber-100 border-l-4 border-amber-400', description: '配送进度跟踪' },
    { id: '8', title: '营销活动发布计划', startTime: '11:00', endTime: '12:00', date: '2025-12-28', color: 'bg-pink-100 border-l-4 border-pink-400', description: '活动发布前准备' },
    { id: '9', title: '设计评审会议', startTime: '06:00', endTime: '09:00', date: '2025-12-25', color: 'bg-emerald-100 border-l-4 border-emerald-400', description: '设计初稿评审' },
    { id: '10', title: '方客户会同步配送', startTime: '09:00', endTime: '10:00', date: '2025-12-29', color: 'bg-amber-100 border-l-4 border-amber-400', description: '周末配送安排' },
    { id: '11', title: '营销活动发布计划', startTime: '11:00', endTime: '12:00', date: '2025-12-27', color: 'bg-pink-100 border-l-4 border-pink-400', description: '营销内容审核' },
  ];
  ...
  // 时间轴（从上午8点到下午2点）
  const timeSlots = [
    '上午8点', '8:40 AM', '上午9点', '上午10点', '上午11点', '上午12点', '下午1点', '下午2点'
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-lg px-3 py-1.5">
                    <button className="px-2 py-1 text-sm text-gray-700 hover:bg-gray-50 rounded">天</button>
                    <button className="px-2 py-1 text-sm bg-gray-100 text-gray-900 rounded">周</button>
                    <button className="px-2 py-1 text-sm text-gray-700 hover:bg-gray-50 rounded">月</button>
                  </div>
                  ...
                  <div className="flex-1 overflow-x-auto">
                    <div className="flex min-w-max">
                      {weekDates.map((date, dayIndex) => {
                        ...
                        return (
                          <div key={dayIndex} className="flex-1 min-w-[140px] border-r border-gray-200 last:border-r-0">
                            {/* 日期头部 */}
                            <div className={`h-16 border-b border-gray-200 flex flex-col items-center justify-center ${
                              isToday ? 'bg-blue-50' : ''
                            }`}>
                              <span className="text-xs text-gray-500">{weekDays[date.getDay()]}{date.getDate()}</span>
                            </div>
                            ...
                            <div className="relative" style={{ height: '640px' }}>
                              ...
                              {dayEvents.map((event) => {
                                ...
                                return (
                                  ...
                                  >
                                    <div className="font-medium text-gray-800 mb-0.5">{event.startTime} - {event.endTime}</div>
      ...
      {/* 日期选择器弹窗 */}
      {showDatePicker && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50" onClick={() => setShowDatePicker(false)}>
      ...
      {/* 添加日程弹窗 */}
      {showAddEventModal && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4" onClick={() => setShowAddEventModal(false)}>
      ...
      {showEventDetail && selectedEvent && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4" onClick={() => setShowEventDetail(false)}>

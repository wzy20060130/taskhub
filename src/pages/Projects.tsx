...
export default function Projects() {
  ...
  const statusConfig = {
    ...
    cancelled: {
      label: '已取消',
      count: getTasksByStatus('cancelled').length,
      color: 'text-red-600',
      dotColor: 'bg-red-600',
    },
  };
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-8">
          {/* 标题 */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">让我们管理您的任务</h2>
                  ...
                  {getTasksByStatus(status as Task['status']).map(task => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div
                          className={`w-10 h-10 ${task.color} rounded-lg flex items-center justify-center`}
                        >
                          <svg

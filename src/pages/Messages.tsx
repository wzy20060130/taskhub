...
export default function Messages() {
  ...
  const conversations: Conversation[] = [
    ...
    },
    {
      ...
      name: '姓名示例',
      avatar: 'B',
      lastMessage: '谢谢！我们需要已经准备好了，我将大概提出更新和下一步',
      time: '6:30',
      unread: false,
    },
    {
    ...
    },
    {
      ...
      name: '姓名示例',
      avatar: 'E',
      lastMessage: '让我们在周五的会议前最终确定用户测试',
      time: '12月12',
      unread: false,
    },
    {
    ...
    '1': [
      {
        ...
        sender: '姓名示例',
        avatar: 'A',
        content: '你好！继续吧，下周一的最终批准将于下周一反予，您能确认入一切是否正确吗？',
        time: '9:00',
        isRead: true,
      },
      {
        ...
        avatar: 'Me',
        content:
          '嗨，亲亚亚，感谢您的提醒！是的，我们每项在昨天之前完成所有内容，我将关注一天结束时给您发送详细的状态更新',
        time: '9:00',
        isRead: true,
      },
      {
        ...
        sender: '姓名示例',
        avatar: 'A',
        content: '太好了！另外，您可以在送之前确保产品页面已针对移动设备进行了优化吗？',
        time: '9:00',
        isRead: true,
      },
      {
        ...
        sender: 'me',
        avatar: 'Me',
        content: '绝对地！我们的质量保证团队已经在测试移动响应能力，我也将他们的技术还给您在更新中',
        time: '9:00',
        isRead: true,
      },
      {
        ...
        sender: '姓名示例',
        avatar: 'A',
        content: '完美，谢谢！让我知道是否还需要我们的其他东西来推进这个',
        time: '9:00',
        isRead: true,
      },
      {
        ...
        sender: 'me',
        avatar: 'Me',
        content: '谢谢，亚亚亚！我们现在已经准备好了，我将天将能提出更新和下一',
        time: '9:00',
        isRead: true,
      },
    ],
